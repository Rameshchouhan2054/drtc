<head>
 ...
 <!-- container --> 
  <section class="showcase">
    <div class="container">
      <form action="<?php echo base_url();?>admin/AdminLoginController/register_user" class="remember-login-frm" id="remember-login-frm" method="post" accept-charset="utf-8" enctype="multipart/form-data">
      <div class="row justify-content-center">
		<div class=" col-md-8 col-lg-6 pb-5">
		<div class="row"><ul style="color: #CB0000"><?php echo validation_errors('<li>', '</li>'); ?></div>
        <!--Form with header-->
            <div class="card  " style="width: 315px;height: 414px;">
